        ...
        <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-grismedio font-[sans-serif]">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-3">
              Tenes alguna idea o marca que queres desarrollar y necesitas
              ayuda? No dudes en consultarme
            </p>
            <div className="mt-12">
              ...
              <ul className="mt-3">
                <li className="flex items-center">
                  ...
                  <a
                    ...
                    className="text-naranja text-sm ml-3"
                  >
                    <small className="block">Mail</small>
                    <strong>Marcos.daut@gmail.com</strong>
                  </a>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <button
              type="button"
              className="text-blanco bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full"
            >
              Enviar
            </button>
          </form>
